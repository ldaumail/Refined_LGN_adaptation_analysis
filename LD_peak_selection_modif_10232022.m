...
%edited on 10/23/2022 to remove the if pk1< 40%*pk2 criterium
...
%  save(strcat(allfilename, '.mat'), 'peaks_locs');
 allfilename = [newdatadir 'su_peaks_03032020_corrected\all_units\clean_origin_sup_50_10232022'];
 save(strcat(allfilename, '.mat'), 'clean_origin_data');
 
 allfilename = [newdatadir 'su_peaks_03032020_corrected\all_units\filt_SUA_sup_50_10232022'];
 save(strcat(allfilename, '.mat'), 'clean_high_SUA');
 allfilename = [newdatadir 'su_peaks_03032020_corrected\all_units\filt_SUA_locs_10232022'];
 save(strcat(allfilename, '.mat'), 'peaks_locs');
...
newdatadir = 'C:\Users\daumail\OneDrive - Vanderbilt\Documents\LGN_data_042021\single_units\inverted_power_channels\good_single_units_data_4bumps_more\new_peak_alignment_anal\su_peaks_03032020_corrected\all_units\';
channelfilename = [newdatadir 'clean_origin_sup_50_10232022']; 
data_file = load(channelfilename);
channelfilename = [newdatadir 'filt_SUA_sup_50_10232022']; 
filt_data_file = load(channelfilename);
locsfilename = [newdatadir 'filt_SUA_locs_10232022'];
...
channelfilename = [gendatadir 'su_peaks_10232022\orig_peak_values\' filename];
%save(strcat(channelfilename, '.mat'), 'peaks');
end  
 mean_peak_vals.peak = mean_peaks;
 allfilename = [gendatadir 'su_peaks_10232022\orig_peak_values\all_units\all_raw_data_peaks'];
 save(strcat(allfilename, '.mat'), 'peak_vals');
 allfilename = [gendatadir 'su_peaks_10232022\orig_peak_values\all_units\all_raw_mean_data_peaks'];
 save(strcat(allfilename, '.mat'), 'mean_peaks');
 savefilename = [gendatadir 'su_peaks_10232022\orig_peak_values\all_units\filenames_layers'];
