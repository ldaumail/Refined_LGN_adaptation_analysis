...
%save(strcat(channelfilename, '.mat'), 'peaks');
 ...
 allfilename = [gendatadir 'su_peaks_03032020\orig_peak_values\all_units\all_norm_mean_data_peaks'];
 save(strcat(allfilename, '.mat'), 'mean_peak_vals');
% savefilename = [gendatadir 'su_peaks_03032020\orig_peak_values\all_units\filenames_layers'];
