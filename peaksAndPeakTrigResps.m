function [peak_vals, peak_aligned_trials] = peaksAndPeakTrigResps(peakLocs,NoFiltMultiContMUA)
%This script is almost identical to "get_origin_peaks.m" as it isolate peak
%values of discretized, convolved original MUA (not smoothed). The script
%also retriggers trial responses to each serial cycle peak location
